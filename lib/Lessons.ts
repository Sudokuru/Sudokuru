    ...
    public static getSteps(strategy: string):string[][] {
        if (strategy === "AMEND_NOTES") {
            ...
            return [
                ...
                ["In the above puzzle we have highlighted a hidden triplet made up of the numbers 1, 5, and 9. They constitute a hidden triplet because they are three cells have a combined three numbers which are absent from every other cell in their shared column (the other cells are highlighted in gold). Therefore, each of them will eventually be filled with one of those three numbers. This lets you remove both every other number from their notes as highlighted in red.", "https://sudokuru.s3.amazonaws.com/Lessons/HIDDEN_SET_STEP_2.png"],
