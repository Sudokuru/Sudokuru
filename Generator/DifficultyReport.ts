...
const sources:string[] = ["http://www.sudokuoftheday.co.uk/", "http://www.sudokuoftheday.co.uk/", "http://www.sudokuoftheday.co.uk/", "http://www.sudokuoftheday.co.uk/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://sudoku.com/", "https://www.websudoku.com/", "https://www.websudoku.com/", "https://www.websudoku.com/", "https://www.websudoku.com/"];
const descriptions:string[] = ["Easy level with 3.5/5 stars", "Easy level with 3.5/5 stars", "Medium level with 5/5 stars", "Medium level with 5/5 stars", "Easy", "Easy", "Medium", "Medium", "Hard", "Hard", "Expert", "Expert", "Evil", "Evil", "Easy", "Medium", "Hard", "Evil"];

function Puzzle(puzzleString, source, description, strategies, givensCount, combinedScore) {
...
for (let i:number = 0; i < puzzles.length; i++) {
    ...
    let combinedScore:number = board.getDifficulty();
    puzzlesArray.push(new Puzzle(puzzles[i], sources[i], descriptions[i], getStrategyString(board.getStrategies()), 81 - (puzzles[i].match(/0/g) || []).length, combinedScore));
}

puzzlesArray.sort((a, b) => (a.combinedScore > b.combinedScore) ? 1 : -1);
